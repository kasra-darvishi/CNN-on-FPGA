...
conv: Convolutional_layer port map (clk, inputReady, addra1, dina1, addra2, dina2, addra3, dina3, newSent, sentence, sentAddr, biases1, biases2, biases3, convRes, convResReady);
softmax: SoftMax_layer port map (clk, convResReady, convRes, weight1, weight2, biases0, oval1, oval2, prediction, outputReady);
