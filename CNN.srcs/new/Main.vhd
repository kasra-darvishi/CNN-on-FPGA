    ...
    if (rising_edge(clk)) then
        if (newInCheck = not newIn) then
            ...
            case state is
                ...
                when getfilt2 =>
                    addra2 <= (99-i)*4*300 + (3-j)*300 + (299-k);
                    dina2 <= inVec;
                    if (i = 0 and j = 0 and k = 0) then
                        i <= 99;
                        j <= 4;
                ...
                when getfilt3 =>
                    addra3 <= (99-i)*5*300 + (4-j)*300 + (299-k);
                    dina3 <= inVec;
                    if (i = 0 and j = 0 and k = 0) then
                        i <= 99;
                        j <= 3;
...
UUT: CNN port map(clk, inputReady, addra1, dina1, addra2, dina2, addra3, dina3, newSent, sentence, sentAddr, biases1, biases2, biases3, weight1, weight2, biases0, oval1, oval2, prediction, outputReady);
