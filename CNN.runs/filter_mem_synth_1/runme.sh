...
HD_PWD='D:/Programming/Projects/CNN-on-FPGA/CNN.runs/filter_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log filter_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source filter_mem.tcl
